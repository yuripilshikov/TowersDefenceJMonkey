...
public class TargetPickCenter extends SimpleApplication {
    ...
    public static void main(String[] args) {
        ...
        settings.setTitle("TargetPickCenter");
            ...
            if (name.equals(MAPPING_ROTATE)) {
                ...
                if (results.size() > 0) {
                    ...
                    for (int i = 0; i < results.size(); i++) {
                        ...
                        String targett = results.getCollision(i).getGeometry().getName();
                        System.out.println("Selection " + i + ": " + targett + " at " + pt + ", " + dist + " WU away");
                    }
    ...
    private void attachCenterMark() {
        ...
        guiNode.attachChild(c); // add it to user niterface node
    }
}
